...
@Component({
  selector: 'app-approve-licenses',
  templateUrl: './approve-licenses.component.html',
  styleUrls: ['./approve-licenses.component.scss']
})
export class ApproveLicensesComponent implements OnInit {
  model: any = {};
