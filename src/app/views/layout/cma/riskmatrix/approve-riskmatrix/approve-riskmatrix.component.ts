...
@Component({
  selector: 'app-approve-riskmatrix',
  templateUrl: './approve-riskmatrix.component.html',
  styleUrls: ['./approve-riskmatrix.component.scss']
})
export class ApproveriskmatrixComponent implements OnInit {
  model: any = {};
